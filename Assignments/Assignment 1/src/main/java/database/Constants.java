...
public class Constants {
    ...
    public static class Rights {
        ...
        public static final String[] RIGHTS = new String[]{CREATE_USER, DELETE_USER, UPDATE_USER, CREATE_CLIENT, DELETE_CLIENT, UPDATE_CLIENT, PROCESS_BILL, TRANSFER_MONEY, GENERATE_REPORTS};
    }
    ...
    public static Map<String, List<String>> getRolesRights() {
        ...
        ROLES_RIGHTS.get(EMPLOYEE).addAll(Arrays.asList(CREATE_USER, DELETE_USER, UPDATE_USER, PROCESS_BILL, TRANSFER_MONEY));
